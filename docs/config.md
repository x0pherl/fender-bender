...
## alternative filament tube details
      tube:
        ...
        outer_diameter: 4.1
## alternative connector details
    - name: "2.5mmx4mmm PC4-M10"
      threaded: True
      file_prefix: "alt/"
      file_suffix: "-2_5mmx4mmm-pc4-m10"
      thread_pitch: 1
      thread_angle: 30
      thread_interference: 0.2
      diameter: 10
...
## alternative filament tube details
      tube:
        ...
        outer_diameter: 4.1
## alternative connector details
    - name: "2mmx4mmm no connector"
      threaded: False
      file_prefix: "alt/"
      file_suffix: "-2mmx4mmm-no-connector"
      thread_pitch: 1
      thread_angle: 30
      thread_interference: 0.2
      diameter: 4.1
...
## alternative filament tube details
      tube:
        ...
        outer_diameter: 4.1
## alternative connector details
    - name: "2mmx4mmm PC4-M10"
      threaded: True
      file_prefix: "alt/"
      file_suffix: "-2mmx4mmm-pc4-m10"
      thread_pitch: 1
      thread_angle: 30
      thread_interference: 0.2
      diameter: 10
