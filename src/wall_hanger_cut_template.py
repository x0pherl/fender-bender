...
def wall_hanger_cut_template(length, width, height:float, bottom:bool=True,
                             post_count=2, tolerance:float=0.2) -> Part:
    ...
    with BuildPart() as cut:
        Box(length, width, cut_unit*2+effective_tolerance,
            align=(Align.MIN, Align.CENTER, Align.MIN))
        with BuildPart(Location((length/2+cut_unit-effective_tolerance,0,
                        cut_unit*2+effective_tolerance))) as lip:
            Box(cut_unit+effective_tolerance, width, cut_unit,
                align=(Align.MIN, Align.CENTER, Align.MIN))
        ...
        with BuildPart(Location((0,0,cut_unit*2+effective_tolerance))) as back_edge:
            Box(cut_unit*2+effective_tolerance,width,height-cut_unit*4,
                align=(Align.MIN, Align.CENTER, Align.MIN))
